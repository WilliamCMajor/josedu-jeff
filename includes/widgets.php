...
class josedu_widget extends WP_Widget {

    /** The __construct() method is used to assign an id, title, classname and description to the widget.  */
    public function __construct() {
        parent::__construct(
            'josedu_widget', // Base ID
            'josedu_widget', // Name
            array( 'description' => __( 'josedu_widget', 'text_domain' ), ) // Args
        );
    }
...
//register the widget
add_action( 'widgets_init', 'josedu_widget_areas' );

if ( ! function_exists( 'josedu_widget_areas' ) ) {

	/** Initializes themes widgets.*/
	function josedu_widget_areas() {

        register_sidebar(
			array(
				'name'          => __( 'Header', 'josedu jeff' ),
				'id'            => 'header-col',
				'description'   => __( 'header-col, widget area', 'josedu jeff' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer one', 'josedu jeff' ),
				'id'            => 'footer-col-one',
				'description'   => __( 'footer-col-one, widget area', 'josedu jeff' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
        ...
        register_sidebar(
			array(
				'name'          => __( 'Footer two', 'josedu jeff' ),
				'id'            => 'footer-col-two',
				'description'   => __( 'footer column two, widget area', 'josedu jeff' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
        ...
        register_sidebar(
			array(
				'name'          => __( 'Footer three', 'josedu jeff' ),
				'id'            => 'footer-col-three',
				'description'   => __( 'footer column three, widget area', 'josedu jeff' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
        ...
        register_sidebar(
			array(
				'name'          => __( 'Footer four', 'josedu jeff' ),
				'id'            => 'footer-col-four',
				'description'   => __( 'footer column four, widget area', 'josedu jeff' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
        ...
        register_sidebar(
			array(
				'name'          => __( 'Right Sidebar', 'josedu jeff' ),
				'id'            => 'sidebar-primary',
				'description'   => __( 'Right Sidebar, Primary widget area', 'josedu jeff' ),
