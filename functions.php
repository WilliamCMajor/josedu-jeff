...
function add_theme_scripts() {
    //Google fonts
    wp_enqueue_style( 'Open Sans', '"https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;700&display=swap" rel="stylesheet"', false);
    ...
    wp_enqueue_style( 'Oxygen', '"https://fonts.googleapis.com/css2?family=Oxygen:wght@400;700&display=swap" rel="stylesheet"', false);
    wp_enqueue_style( 'Abril Fatface', '"https://fonts.googleapis.com/css2?family=Abril+Fatface&display=swap" rel="stylesheet"', false);
    
    //styles
    wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/assets/css/bootstrap.min.css', false, '1.0','all');
    wp_enqueue_style( 'animate style', get_template_directory_uri() . '/assets/css/animate.min.css', false, '1.0','all');
...
$josedu_includes = array (
    '/widgets.php',
);

foreach ($josedu_includes as $file) {
